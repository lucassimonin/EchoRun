...
export function TimeLiveClient({
  ...
  }, [durationS, messages, playedIds, raceId]);
      ...
      <main className="mx-auto max-w-lg px-5 py-12 sm:px-8">
        ...
        <Surface className="mt-6">
          ...
          <p className="mt-2 text-[14px] text-charcoal-muted">
            Objectif {formatClock(durationS)} · {remaining.length} message
          ...
          <ul className="space-y-3 text-[13.5px] leading-relaxed text-charcoal-muted">
            <li className="flex gap-2.5">
              <Dot />
              <span>Mets tes écouteurs et lance le chrono au moment où tu passes la ligne de départ.</span>
            </li>
            <li className="flex gap-2.5">
              <Dot />
              <span>
                Garde cette page au premier plan, écran allumé : c’est nécessaire pour que le son se
                déclenche.
              </span>
            </li>
            <li className="flex gap-2.5">
              <Dot />
              <span>Les messages partent à la minute prévue de ton chrono, sans réseau.</span>
            </li>
          </ul>
            ...
            <p className="mt-1 text-[14.5px] text-charcoal">
              ...
              {(nextMessage.trigger_at_s ?? 0) > elapsedS ? (
                <span className="text-charcoal-faint">
                  {' '}
                  · dans {formatStopwatch((nextMessage.trigger_at_s ?? 0) - elapsedS)}
                </span>
              ) : null}
            </p>
          </div>
